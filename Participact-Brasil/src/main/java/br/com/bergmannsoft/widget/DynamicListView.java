package br.com.bergmannsoft.widget;
...
//    public ArrayList mCheeseList;
    ...
    public interface DynamicListViewSwapListener {
        void onSwapElements(int from, int to);
    }

    DynamicListViewSwapListener swapListener;
    ...
    public void setSwapListener(DynamicListViewSwapListener swapListener) {
...
//            swapElements(mCheeseList, originalItem, getPositionForView(switchView));
            ...
            int from = originalItem;
            int to = getPositionForView(switchView);
            ...
            swapListener.onSwapElements(from, to);
...
//    }
    ...
    private void touchEventsEnded() {
        ...
        if (mCellIsMobile || mIsWaitingForScrollFinish) {
            ...
            if (mobileView == null) {
                invisibleItemView.setVisibility(VISIBLE);
                ((BaseAdapter) getAdapter()).notifyDataSetChanged();
                return;
            }
