...
public class SensorDao extends AbstractDao<Sensor, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Sensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Sensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Sensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Sensor entity) {
