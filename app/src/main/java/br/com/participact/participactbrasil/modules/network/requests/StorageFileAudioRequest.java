...
public class StorageFileAudioRequest extends StorageFileRequest {

    Long reportId;
    Integer duration;

    public StorageFileAudioRequest(File file, Long reportId, Integer duration) {
    ...
    public Call<Response> call(Map<String, String> defaultHeaders, Retrofit retrofit, ProgressRequestBody.ProgressCallback progress) {
        ...
        return api.uploadAudio(map(defaultHeaders), body(progress));
    }
