...
import org.most.input.LocationInput;
    ...
    public Input getInput(Input.Type inputType) {
        ...
        switch (inputType) {
            ...
            case CONTINUOUS_FUSION_LOCATION:
                ...
                break;
            case PERIODIC_FUSION_LOCATION: // this is used
//                result = new PeriodicFusionLocationInput(_context);
                result = new LocationInput(_context);
                break;
            ...
            case PERIODIC_ACCELEROMETER:
                result = new PeriodicAccelerometerInput(_context);
                break;
            default:
