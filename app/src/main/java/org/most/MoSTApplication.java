...
public class MoSTApplication extends BApplication {
    ...
    private static MoSTApplication instance;

    public static MoSTApplication getInstance() {
        return instance;
    }

    public boolean isPipelineActive(Integer i) {
        Pipeline pipeline = _pipelineManager.getPipeline(Pipeline.Type.fromInt(i));
        if (pipeline != null) {
