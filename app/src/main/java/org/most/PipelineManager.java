...
import org.most.pipeline.PipelineTraining;
...
public class PipelineManager {
    ...
    public boolean isActive(Pipeline.Type type) {
        return _pipelines.get(type) != null;
    }
     ...
     *
     * @param pipelineType Type of the pipeline to get.
     * @return The pipeline.
     */
    public Pipeline getPipeline(Pipeline.Type pipelineType) {
        ...
        switch (pipelineType) {
            ...
            case GOOGLE_ACTIVITY_RECOGNITION:
                ...
                break;
            case DR:
                result = new PipelineDR(_context);
                break;
            case TRAINING:
                result = new PipelineTraining(_context);
                break;
...
//                throw new IllegalArgumentException();
     ...
     *
     * @param pipelineType The type of the pipeline to look for.
     ...
     *
     * @param pipeline The pipeline to init.
     */
     ...
     * method.
     *
     * @param pipeline The pipeline to deactivate.
     */
     ...
     *
     * @param pipeline The pipeline to finalize.
     */
