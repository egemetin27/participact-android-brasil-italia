...
public abstract class Input {
     ...
     * state.
     *
     * @param newState The new state to which the Input should switch.
     * @throws IllegalStateException if the new state is invalid
     * @see Input#getState()
     */
