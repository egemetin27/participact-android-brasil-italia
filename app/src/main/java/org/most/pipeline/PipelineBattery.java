...
public class PipelineBattery extends Pipeline {
    ...
    public static final String FLD_BATTERY_LEVEL = "batteryLevel";
    ...
    public static final String FLD_BATTERY_STATUS = "batteryState";
    ...
    public void onData(DataBundle b) {
        try {
            ...
            cv.put(FLD_TIMESTAMP, System.currentTimeMillis() / 1000);
