...
public class PipelineGoogleActivityRecognition extends Pipeline {
    ...
    public void onData(DataBundle b) {
        try {
            ...
            map.put("confidence", b.getInt(GoogleActivityRecognitionInput.KEY_CONFIDENCE));
            map.put("stationary", b.getInt(GoogleActivityRecognitionInput.KEY_RECOGNIZED_ACTIVITY));
            map.put("walking", b.getInt(GoogleActivityRecognitionInput.KEY_RECOGNIZED_ACTIVITY));
            map.put("running", b.getInt(GoogleActivityRecognitionInput.KEY_RECOGNIZED_ACTIVITY));
            map.put("automotive", b.getInt(GoogleActivityRecognitionInput.KEY_RECOGNIZED_ACTIVITY));
            map.put("unknown", b.getInt(GoogleActivityRecognitionInput.KEY_RECOGNIZED_ACTIVITY));
            map.put("recognizedActivity", b.getInt(GoogleActivityRecognitionInput.KEY_RECOGNIZED_ACTIVITY));
