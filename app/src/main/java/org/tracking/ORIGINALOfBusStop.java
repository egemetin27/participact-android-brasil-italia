...
public class ORIGINALOfBusStop {
    ...
    public ORIGINALOfBusStop(GPSPosition position, String name, String code, String location, List<BusLine> lines, int zone_code, double error) {
        super();
    ...
    public List<BusLine> linesInCommon(ORIGINALOfBusStop other) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ORIGINALOfBusStop other = (ORIGINALOfBusStop) obj;
        if (code == null) {
            if (other.code != null)
                return false;
